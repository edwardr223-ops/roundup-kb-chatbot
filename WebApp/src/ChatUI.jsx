...
const ChatUI = React.forwardRef(({
  ...
  const [selectedSubType, setSelectedSubType] = useState({ label: 'Dennis v. Monsanto', value: 'dennis_clh_ca' });

  const subTypeOptions = useMemo(() => {
    return selectedDocType?.value === 'deposition' ? depositionOptions : caseOptions;
  }, [selectedDocType, depositionOptions, caseOptions]);

  const subTypePlaceholder = useMemo(() => {
    return selectedDocType?.value === 'deposition' ? 'Deponent' : 'Case';
  }, [selectedDocType]);
        ...
        if (supportsStreaming) {
          ...
          result = await invokeBedrockRetrieveAndGenerateStreamCommand(
            ...
            handleStreamChunk,
            {
              ...
              caseId: selectedDocType?.value === 'deposition' ? null : (selectedSubType?.value || null),
          ...
          result = await invokeBedrockAgent(
            enhancedInput,
            chatSessionId,
            credentials,
            [],
    ...
    <div style={{ 
      ...
      <div className="chat-ui-content-wrapper">
        <SpaceBetween size="s">
                      ...
                      <>
                        ...
                        <div style={{ width: '270px', minWidth: '270px', maxWidth: '270px' }}>
                          <Select
                            ...
                            onChange={({ detail }) => setSelectedSubType(detail.selectedOption)}
          ...
          {(currentSessionMessages.length > 0 || isLoading) && (
            <Container fitHeight>
              ...
              <div className="prompt-container" style={{
                ...
                <div className="prompt-wrapper">
                  <PromptInput
                    ...
                    expandToViewport={isMobile}
                    expandableGroups={isMobile}
